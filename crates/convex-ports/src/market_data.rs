...
impl BondQuote {
    ...
    pub fn price_for_side(&self, side: crate::ports::storage::QuoteSide) -> Option<Decimal> {
    ...
    pub fn yield_for_side(&self, side: crate::ports::storage::QuoteSide) -> Option<Decimal> {
        use crate::ports::storage::QuoteSide;
        match side {
