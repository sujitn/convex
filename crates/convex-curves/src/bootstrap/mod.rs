...
// Re-export the new bootstrappers
pub use global::{
...
// ============================================================================
// Legacy Bootstrap API (maintained for backward compatibility)
// ============================================================================
...
/// A market instrument for bootstrapping (legacy API).
///
/// For new code, prefer using the `SequentialBootstrapper` with
/// the `CurveInstrument` trait.
#[derive(Debug, Clone)]
...
/// Bootstraps a zero curve from market instruments (legacy API).
///
/// For new code, prefer using `SequentialBootstrapper` which works
/// with the `CurveInstrument` trait and returns a `DiscountCurve`.
///
/// # Arguments
///
