...
use convex_bonds::types::AmortizationSchedule;

use crate::error::{AnalyticsError, AnalyticsResult};

use super::accrued::AccruedInterestCalculator;
...
impl CashFlowGenerator {
    ...
    pub fn generate(bond: &FixedBond, settlement: Date) -> AnalyticsResult<CashFlowSchedule> {
        ...
        while date > settlement {
            ...
            date = date.add_months(-months_per_period).map_err(|e| {
