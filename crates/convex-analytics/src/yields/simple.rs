...
mod tests {
    ...
    #[test]
    fn test_simple_yield_zero_price_error() {
        let result = simple_yield(dec!(5.0), dec!(0.0), dec!(100.0), dec!(5.0));
        assert!(result.is_err());
    }

    #[test]
    fn test_simple_yield_zero_years_error() {
        let result = simple_yield(dec!(5.0), dec!(100.0), dec!(100.0), dec!(0.0));
        assert!(result.is_err());
    }
}
